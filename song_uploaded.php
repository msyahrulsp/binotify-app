...
if ($uploadOk == 0) {
  ...
  // echo 'move song' . move_uploaded_file($_FILES["songToUpload"]["tmp_name"], $target_file_song);
  // echo 'move image' . move_uploaded_file($_FILES["imageToUpload"]["tmp_name"], $target_file_image);
